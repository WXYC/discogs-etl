...
**`library.db`** -- SQLite export of the WXYC library catalog (sourced from the MySQL database on Kattare). Generated by `scripts/export_to_sqlite.py` in the [request-o-matic](https://github.com/WXYC/request-o-matic) repo:
